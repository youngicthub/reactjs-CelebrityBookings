      ...
      <section className="bg-gradient-to-br from-primary/10 to-primary/5 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            From Hollywood stars to sports legends, find and book the perfect
            celebrity for your next event
          </p>
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <div className="flex items-center gap-2 bg-background/60 backdrop-blur-sm px-4 py-2 rounded-full">
              ...
              <span>
                {
                  celebrities.filter((c) => c.availability === "available")
                    .length
                }{" "}
                Available Now
              </span>
            ...
            <div className="flex items-center gap-2 bg-background/60 backdrop-blur-sm px-4 py-2 rounded-full">
              ...
              <span>
                {celebrities.filter((c) => c.availability === "busy").length}{" "}
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="text-sm text-muted-foreground">
            Showing {filteredAndSortedCelebrities.length} of{" "}
